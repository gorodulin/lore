...
class FactStore:
    ...
    def find_matching_facts(self, file_path: str, content: str | None = None, description: str | None = None, command: str | None = None, tags: list[str] | None = None) -> dict[str, dict]:
        ...
        matching_ids = find_matching_facts(self._facts, rel_path, content=content, description=description, command=command)
        if not matching_ids:
            return {}

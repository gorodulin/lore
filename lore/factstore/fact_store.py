...
class FactStore:
    ...
    def find_matching_facts(self, file_path: str, content: str | None = None, description: str | None = None, command: str | None = None, tools: tuple[str, ...] | None = None, endpoints: tuple[str, ...] | None = None, tags: list[str] | None = None) -> dict[str, dict]:
        ...
        matching_ids = find_matching_facts(self._facts, rel_path, content=content, description=description, command=command, tools=tools, endpoints=endpoints)
        if not matching_ids:
            return {}

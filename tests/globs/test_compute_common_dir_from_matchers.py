...
def test_single_glob_pattern():
    result = compute_common_dir_from_matchers(["g:lore/globs/**/*.py"])
...
def test_multiple_patterns_common_prefix():
    result = compute_common_dir_from_matchers([
        "g:lore/globs/**/*.py",
        "g:lore/globs/compile_glob_pattern.py",
    ])
    assert result == "lore/globs"
...
def test_globstar_only():
    result = compute_common_dir_from_matchers(["g:**/*.py"])
    assert result == "."
...
def test_literal_file_pattern():
    ...
    result = compute_common_dir_from_matchers(["g:src/utils/file.py"])
    assert result == "src/utils"


def test_directory_pattern():
    result = compute_common_dir_from_matchers(["g:src/utils/"])
    assert result == "src/utils"
